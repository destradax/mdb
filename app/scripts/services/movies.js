...
mdb.service("moviesService", function () {
	...
	this.getSampleMovies = function () {
		return [
			{id: 1, title: "The Godfather II", director: "Francis Ford Coppola", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/godfather2.png", rating: 89, releaseYear: 1974, excerpt: "The early life and career of Vito Corleone in 1920s New York is portrayed while his son, Michael, expands and tightens his grip on his crime syndicate stretching from Lake Tahoe, Nevada to pre-revolution 1958 Cuba."},
			{id: 2, title: "Saving Private Ryan", director: "Steven Spielberg", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/savingprivateryan.png", rating: 64, releaseYear: 1998, excerpt: "Following the Normandy Landings, a group of U.S. soldiers go behind enemy lines to retrieve a paratrooper whose brothers have been killed in action."},
			{id: 3, title: "The Butterfly Effect", director: "Eric Bress", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/butterflyeffect.png", rating: 43, releaseYear: 2004, excerpt: "A young man blocks out harmful memories of significant events of his life. As he grows up, he finds a way to remember these lost memories and a supernatural way to alter his life."},
			{id: 4, title: "Fight Club", director: "David Fincher", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/fightclub.png", rating: 21, releaseYear: 1999, excerpt: "An insomniac office worker, looking for a way to change his life, crosses paths with a devil-may-care soap maker, forming an underground fight club that evolves into something much, much more..."},
			{id: 5, title: "The Godfather", director: "Francis Ford Coppola", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/godfather1.png", rating: 21, releaseYear: 1972, excerpt: "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son."},
			{id: 6, title: "Better Call Saul", director: "Adam Bernstein", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/bettercallsaul.png", rating: 19, releaseYear: 2105, excerpt: "The trials and tribulations of criminal lawyer, Saul Goodman, in the time leading up to establishing his strip-mall law office in Albuquerque, New Mexico."},
			{id: 7, title: "Street Fighter", director: "Steven E. de Souza", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/streetfighter.png", rating: 17, releaseYear: 2016, excerpt: "Col. Guile and various other martial arts heroes fight against the tyranny of Dictator M. Bison and his cohorts."},
			{id: 8, title: "Black Adder", director: "Martin Shardlow", actorIds: [], genres: [], grossIncome: 999, imgUrl: "img/blackadder.png", rating: 5, releaseYear: 1982, excerpt: "In the Middle Ages, Prince Edmund the Black Adder constantly schemes and endeavors to seize the crown from his father and brother."}
		];
	};
